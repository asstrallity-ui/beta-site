...
document.addEventListener('DOMContentLoaded', () => {
    ...
    navItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            if (target === 'mods') { pageTitle.innerText = "Каталог модов"; loadMods(); }
...
function openRepairModal() {
    ...
    if(globalInstalledIds.length === 0) repairList.innerHTML = '<div style="text-align:center;padding:20px;color:#666;">Пусто</div>';
    else {
...
async function doRestore(id) {
    ...
    else showToast("Ошибка: " + res.message);
}
...
function renderSettings() {
    contentArea.innerHTML = `
        <div class="settings-section">
            ...
            <div class="setting-item">
                <div class="setting-info"><h4>Цвет темы</h4></div>
